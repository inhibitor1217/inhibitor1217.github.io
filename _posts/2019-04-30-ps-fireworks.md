---
layout: post
title: "[PS] 불꽃놀이 (fireworks)"
tags: [PS, COCI, Segment Tree]
---
## 불꽃놀이 (fireworks) - COCI 2009/2010
...
- 2~3 번째 불꽃을 담고 있는 사진은 2번 색 불꽃이 전체의 절반(1.5개)보다 많이 있기 때문에 단조롭다.
...
![cumulative-sum-1]({{site.url}}/images/ps-fireworks-cumulative-sum-1.PNG)
...
![bucket-1]({{site.url}}/images/ps-fireworks-bucket-1.PNG)
...
![segment-tree-1]({{site.url}}/images/ps-fireworks-segment-tree-1.PNG)
...
![segment-tree-2]({{site.url}}/images/ps-fireworks-segment-tree-2.PNG)
...
![segment-tree-3]({{site.url}}/images/ps-fireworks-segment-tree-3.PNG)

마찬가지로, 계속해서 위로 올라가면서 같은 방법으로 버킷의 색깔을 결정합니다.

![segment-tree-4]({{site.url}}/images/ps-fireworks-segment-tree-4.PNG)
...
![segment-tree-5]({{site.url}}/images/ps-fireworks-segment-tree-5.PNG)
