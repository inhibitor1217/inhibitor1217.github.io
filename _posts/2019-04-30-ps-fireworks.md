...
![cumulative-sum-1](ps-fireworks-cumulative-sum-1.PNG)
...
![bucket-1](ps-fireworks-bucket-1.PNG)
...
![segment-tree-1](ps-fireworks-segment-tree-1.PNG)
...
![segment-tree-2](ps-fireworks-segment-tree-2.PNG)
...
![segment-tree-3](ps-fireworks-segment-tree-3.PNG)

마찬가지로, 계속해서 위로 올라가면서 같은 방법으로 버킷의 색깔을 결정합니다.

![segment-tree-4](ps-fireworks-segment-tree-4.PNG)
...
![segment-tree-5](ps-fireworks-segment-tree-5.PNG)
